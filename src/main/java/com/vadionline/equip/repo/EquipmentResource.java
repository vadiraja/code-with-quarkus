...
//    }
    ...
    //Get single equipment completion stage using services
    @GET
    @Path("/{id}")
    public Response getSingleEquipment(@PathParam("id") Long id) {
//        Equipment equipment = equipmentService.getEquipmentByEid(id);
    ...
    @GET
    @Path("/{id}/logs")
    public Response getEquipmentLogs(@PathParam("id") Long id) {

        return Response.ok(equipmentService.getMaintenanceLogs(id)).build();
    }
